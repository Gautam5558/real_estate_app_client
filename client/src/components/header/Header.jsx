    ...
    <div className="header">
      <div className="container">
        ...
        <div className="links" style={getMenuStyles(open)}>
          <Link to="/residencies" onClick={() => setOpen(false)}>
            Residencies
          </Link>
          <a
            href="#contact"
          ...
          {state.user && (
            <>
              <div
                className="dItem hidden"
                onClick={() => {
                  navigate("/protected/favorites");
                  setOpen(false);
                }}
              >
                Favorites
              ...
              <div
                className="dItem hidden"
                onClick={() => {
                  navigate("/protected/bookings");
                  setOpen(false);
                }}
              >
                Bookings
              </div>
              <span className="addLink" onClick={openModal}>
                Add Property
              </span>
              <div
                className="dItem hidden"
              ...
              <button
                className="hButton hidden dItem"
                onClick={() => {
                  handleLogout();
                }}
              >
          ...
          {state.user ? (
            <>
              ...
              >
                <img
                  src={state.user.image ? state.user.image : "/noavatar.jpg"}
                  className="avatar"
                />
              </div>
              {dropdown && (
