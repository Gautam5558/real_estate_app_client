            ...
            <div className="lWrapper">
                <form className='lForm' onSubmit={(e) => { handleSubmit(e) }}>
                    ...
                    <div className="entry">
                        ...
                        <input type='email' placeholder='@bob.com' className='lInput' value={loginData.email} name='email' onChange={(e) => { handleChange(e) }} />
                    </div>
                    <div className="entry">
                        <label className='lLabel orangeText'>Password</label>
                        <input type='password' className='lnput' name='password' value={loginData.password} onChange={(e) => { handleChange(e) }} />
                    </div>
                    <button disabled={state.loading} className='lButton'>{state.loading ? "logging in" : "signup"}</button>
